---
title: "OKSM_Senolytic RNA-Seq Analysis (iPSC)"
author: Ellora Chua
output: 
  html_document:
    toc: true
...
knitr::opts_chunk$set(fig.width=12, fig.height=8, fig.path='./figures/ipsc/',
...
for( i in experimental_metadata$sample_id){
  data[,i] = read.table(paste("data/ipsc/", i, ".genes.results",sep=""), sep="\t", header=TRUE)$expected_count
}
row.names(data) = read.table(paste("data/ipsc/", i, ".genes.results",sep=""), sep="\t", header=TRUE)$gene_id
...
if(!dir.exists("output/ipsc")){
  dir.create(file.path(getwd(),"output/ipsc"), recursive = TRUE)
}
output_dir <- "output/ipsc/"
```
...
saveRDS(pam_clust, "output/ipsc/pam_clust.rds")
...
write.table(dds_df, "output/ipsc/clusters.csv", row.names = TRUE, col.names = TRUE)
```
...
get_important_terms(eresList$GO_Biological_Process_2018, output_dir, "ipsc_c1_go")
```
...
get_important_terms(eresList$KEGG_2019, output_dir, "ipsc_c1_kegg")
```
...
eresList$GO_Biological_Process_2018 %>%
  plot_enrichr("GO_Biological_Process_2018")
datatable(eresList[[1]], options = list(scrollX = TRUE), class = "white-space: nowrap")
get_important_terms(eresList$GO_Biological_Process_2018, output_dir, "ipsc_c2_go")
```
...
eresList$KEGG_2019 %>%
  plot_enrichr("KEGG_2019") 
datatable(eresList[[2]], options = list(scrollX = TRUE), class = "white-space: nowrap")
get_important_terms(eresList$KEGG_2019, output_dir, "ipsc_c2_kegg")
```
...
eresList$GO_Biological_Process_2018 %>%
  plot_enrichr("GO_Biological_Process_2018")
datatable(eresList[[1]], options = list(scrollX = TRUE), class = "white-space: nowrap")
get_important_terms(eresList$GO_Biological_Process_2018, output_dir, "ipsc_c3_go")
```
...
eresList$KEGG_2019 %>%
  plot_enrichr("KEGG_2019") 
datatable(eresList[[2]], options = list(scrollX = TRUE), class = "white-space: nowrap")
get_important_terms(eresList$KEGG_2019, output_dir, "ipsc_c3_kegg")
```
...
eresList$GO_Biological_Process_2018 %>%
  plot_enrichr("GO_Biological_Process_2018")
datatable(eresList[[1]], options = list(scrollX = TRUE), class = "white-space: nowrap")
get_important_terms(eresList$GO_Biological_Process_2018, output_dir, "ipsc_c4_go")
```
...
eresList$KEGG_2019 %>%
  plot_enrichr("KEGG_2019") 
datatable(eresList[[2]], options = list(scrollX = TRUE), class = "white-space: nowrap")
get_important_terms(eresList$KEGG_2019, output_dir, "ipsc_c4_kegg")
```
...
eresList$GO_Biological_Process_2018 %>%
  plot_enrichr("GO_Biological_Process_2018")
datatable(eresList[[1]], options = list(scrollX = TRUE), class = "white-space: nowrap")
get_important_terms(eresList$GO_Biological_Process_2018, output_dir, "ipsc_c5_go")
```
...
eresList$KEGG_2019 %>%
  plot_enrichr("KEGG_2019") 
datatable(eresList[[2]], options = list(scrollX = TRUE), class = "white-space: nowrap")
get_important_terms(eresList$KEGG_2019, output_dir, "ipsc_c5_kegg")
```
...
eresList$GO_Biological_Process_2018 %>%
  plot_enrichr("GO_Biological_Process_2018")
datatable(eresList[[1]], options = list(scrollX = TRUE), class = "white-space: nowrap")
get_important_terms(eresList$GO_Biological_Process_2018, output_dir, "ipsc_c6_go")
```
...
eresList$KEGG_2019 %>%
  plot_enrichr("KEGG_2019") 
datatable(eresList[[2]], options = list(scrollX = TRUE), class = "white-space: nowrap")
get_important_terms(eresList$KEGG_2019, output_dir, "ipsc_c6_kegg")
```
...
eresList$GO_Biological_Process_2018 %>%
  plot_enrichr("GO_Biological_Process_2018")
datatable(eresList[[1]], options = list(scrollX = TRUE), class = "white-space: nowrap")
get_important_terms(eresList$GO_Biological_Process_2018, output_dir, "ipsc_c7_go")
```
...
eresList$KEGG_2019 %>%
  plot_enrichr("KEGG_2019") 
datatable(eresList[[2]], options = list(scrollX = TRUE), class = "white-space: nowrap")
get_important_terms(eresList$KEGG_2019, output_dir, "ipsc_c7_kegg")
```
