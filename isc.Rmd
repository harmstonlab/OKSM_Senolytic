...
<!-- ```{r} -->
<!-- genes_plot <- as.data.frame(counts(dds, normalized = TRUE)[c("FBgn0053542", "FBgn0000490"), ]) -->

<!-- genes_plot_long <- genes_plot %>% -->
<!--   pivot_longer(cols = everything()) -->
<!-- genes_plot_long <- genes_plot_long %>% -->
<!--   mutate(gene = c(rep("upd3", 12), rep("dpp", 12)), -->
<!--          condition =factor( -->
<!--            ifelse(genes_plot_long$name %in% c("Control_1", "Control_2", "Control_3"), "Control", -->
<!--                   ifelse(genes_plot_long$name %in% c("O1", "O2", "O3"), "OKSM", -->
<!--                          ifelse(genes_plot_long$name %in% c("S1", "S2", "S3"), "Sen", "Sen_OKSM"))),  -->
<!--            levels = c("Control", "OKSM", "Sen", "Sen_OKSM"))) -->
...
<!--   geom_point(data=genes_plot_long[genes_plot_long$gene=="upd3",], aes(x=condition, y=value), size=2) -->
...
<!--         axis.ticks.x = element_blank()) + -->
<!--   scale_fill_manual(values = c("#BF3100", "#E9B44C", "#1B998B", "#5D576B"))+ -->
<!--   geom_point(data=genes_plot_long[genes_plot_long$gene=="dpp",], aes(x=condition, y=value), size=2) -->
