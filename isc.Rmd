...
get_important_terms(eresList$GO_Biological_Process_2018, output_dir, "isc_c1_go")
```
...
get_important_terms(eresList$KEGG_2019, output_dir, "isc_c1_kegg")
```
...
eresList$GO_Biological_Process_2018 %>%
  plot_enrichr("GO_Biological_Process_2018")
datatable(eresList[[1]], options = list(scrollX = TRUE), class = "white-space: nowrap")
get_important_terms(eresList$GO_Biological_Process_2018, output_dir, "isc_c2_go")
```
...
eresList$KEGG_2019 %>%
  plot_enrichr("KEGG_2019") 
datatable(eresList[[2]], options = list(scrollX = TRUE), class = "white-space: nowrap")
get_important_terms(eresList$KEGG_2019, output_dir, "isc_c2_kegg")
```
...
eresList$GO_Biological_Process_2018 %>%
  plot_enrichr("GO_Biological_Process_2018")
datatable(eresList[[1]], options = list(scrollX = TRUE), class = "white-space: nowrap")
get_important_terms(eresList$GO_Biological_Process_2018, output_dir, "isc_c3_go")
```
...
eresList$KEGG_2019 %>%
  plot_enrichr("KEGG_2019") 
datatable(eresList[[2]], options = list(scrollX = TRUE), class = "white-space: nowrap")
get_important_terms(eresList$KEGG_2019, output_dir, "isc_c3_kegg")
```
...
eresList$GO_Biological_Process_2018 %>%
  plot_enrichr("GO_Biological_Process_2018")
datatable(eresList[[1]], options = list(scrollX = TRUE), class = "white-space: nowrap")
get_important_terms(eresList$GO_Biological_Process_2018, output_dir, "isc_c4_go")
```
...
eresList$KEGG_2019 %>%
  plot_enrichr("KEGG_2019") 
datatable(eresList[[2]], options = list(scrollX = TRUE), class = "white-space: nowrap")
get_important_terms(eresList$KEGG_2019, output_dir, "isc_c4_kegg")
```
...
eresList$GO_Biological_Process_2018 %>%
  plot_enrichr("GO_Biological_Process_2018")
datatable(eresList[[1]], options = list(scrollX = TRUE), class = "white-space: nowrap")
get_important_terms(eresList$GO_Biological_Process_2018, output_dir, "isc_c5_go")
```
...
eresList$KEGG_2019 %>%
  plot_enrichr("KEGG_2019") 
datatable(eresList[[2]], options = list(scrollX = TRUE), class = "white-space: nowrap")
get_important_terms(eresList$KEGG_2019, output_dir, "isc_c5_kegg")
```
...
eresList$GO_Biological_Process_2018 %>%
  plot_enrichr("GO_Biological_Process_2018")
datatable(eresList[[1]], options = list(scrollX = TRUE), class = "white-space: nowrap")
get_important_terms(eresList$GO_Biological_Process_2018, output_dir, "isc_c6_go")
```
...
eresList$KEGG_2019 %>%
  plot_enrichr("KEGG_2019") 
datatable(eresList[[2]], options = list(scrollX = TRUE), class = "white-space: nowrap")
get_important_terms(eresList$KEGG_2019, output_dir, "isc_c6_kegg")
```
...
eresList$GO_Biological_Process_2018 %>%
  plot_enrichr("GO_Biological_Process_2018")
datatable(eresList[[1]], options = list(scrollX = TRUE), class = "white-space: nowrap")
get_important_terms(eresList$GO_Biological_Process_2018, output_dir, "isc_c7_go")
```
...
eresList$KEGG_2019 %>%
  plot_enrichr("KEGG_2019") 
datatable(eresList[[2]], options = list(scrollX = TRUE), class = "white-space: nowrap")
get_important_terms(eresList$KEGG_2019, output_dir, "isc_c7_kegg")
```
