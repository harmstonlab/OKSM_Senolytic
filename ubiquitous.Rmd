...
eresList$KEGG_2019 %>%
  plot_enrichr("KEGG_2019") 
datatable(eresList[[2]], options = list(scrollX = TRUE), class = "white-space: nowrap")
write.csv(eresList$GO_Biological_Process_2018, paste0(output_dir,"c4_kegg.csv"), row.names = T, col.names = T)
get_important_terms(eresList$GO_Biological_Process_2018, output_dir, "ubi_c4_kegg")
```
