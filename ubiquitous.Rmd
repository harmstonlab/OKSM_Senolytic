...
write.table(dds_df, "output/ubiquitous/clusters.csv", row.names = TRUE, col.names = TRUE)
```
...
get_important_terms(eresList$GO_Biological_Process_2018, output_dir, "ubi_c7_go")
```

### KEGG_2019
```{r c1_kegg_9, fig.width=8}
eresList$KEGG_2019 %>%
  plot_enrichr("KEGG_2019") 
datatable(eresList[[2]], options = list(scrollX = TRUE), class = "white-space: nowrap")
get_important_terms(eresList$KEGG_2019, output_dir, "ubi_c7_kegg")
```
...
### GO_Biological_Process_2018
```{r c2_go_9, fig.width=8}
eresList$GO_Biological_Process_2018 %>%
  plot_enrichr("GO_Biological_Process_2018")
datatable(eresList[[1]], options = list(scrollX = TRUE), class = "white-space: nowrap")
get_important_terms(eresList$GO_Biological_Process_2018, output_dir, "ubi_c1_go")
```

### KEGG_2019
```{r c2_kegg_9, fig.width=8}
eresList$KEGG_2019 %>%
  plot_enrichr("KEGG_2019") 
datatable(eresList[[2]], options = list(scrollX = TRUE), class = "white-space: nowrap")
get_important_terms(eresList$KEGG_2019, output_dir, "ubi_c1_kegg")
```
...
### GO_Biological_Process_2018
```{r c3_go_9, fig.width=8}
eresList$GO_Biological_Process_2018 %>%
  plot_enrichr("GO_Biological_Process_2018")
datatable(eresList[[1]], options = list(scrollX = TRUE), class = "white-space: nowrap")
get_important_terms(eresList$GO_Biological_Process_2018, output_dir, "ubi_c2_go")
```

### KEGG_2019
```{r c3_kegg_9, fig.width=8}
eresList$KEGG_2019 %>%
  plot_enrichr("KEGG_2019") 
datatable(eresList[[2]], options = list(scrollX = TRUE), class = "white-space: nowrap")
get_important_terms(eresList$KEGG_2019, output_dir, "ubi_c2_kegg")
```
...
### GO_Biological_Process_2018
```{r c4_go_9, fig.width=8}
eresList$GO_Biological_Process_2018 %>%
  plot_enrichr("GO_Biological_Process_2018")
datatable(eresList[[1]], options = list(scrollX = TRUE), class = "white-space: nowrap")
get_important_terms(eresList$GO_Biological_Process_2018, output_dir, "ubi_c3_go")
```

### KEGG_2019
```{r c4_kegg_9, fig.width=8}
eresList$KEGG_2019 %>%
  plot_enrichr("KEGG_2019") 
datatable(eresList[[2]], options = list(scrollX = TRUE), class = "white-space: nowrap")
get_important_terms(eresList$KEGG_2019, output_dir, "ubi_c3_kegg")
```
...
### GO_Biological_Process_2018
```{r c5_go_9, fig.width=8}
eresList$GO_Biological_Process_2018 %>%
  plot_enrichr("GO_Biological_Process_2018")
datatable(eresList[[1]], options = list(scrollX = TRUE), class = "white-space: nowrap")
get_important_terms(eresList$GO_Biological_Process_2018, output_dir, "ubi_c5_go")
```

### KEGG_2019
```{r c5_kegg_9, fig.width=8}
eresList$KEGG_2019 %>%
  plot_enrichr("KEGG_2019") 
datatable(eresList[[2]], options = list(scrollX = TRUE), class = "white-space: nowrap")
get_important_terms(eresList$KEGG_2019, output_dir, "ubi_c5_kegg")
```
...
### GO_Biological_Process_2018
```{r c6_go_9, fig.width=8}
eresList$GO_Biological_Process_2018 %>%
  plot_enrichr("GO_Biological_Process_2018")
datatable(eresList[[1]], options = list(scrollX = TRUE), class = "white-space: nowrap")
get_important_terms(eresList$GO_Biological_Process_2018, output_dir, "ubi_c6_go")
```

### KEGG_2019
```{r c6_kegg_9, fig.width=8}
eresList$KEGG_2019 %>%
  plot_enrichr("KEGG_2019") 
datatable(eresList[[2]], options = list(scrollX = TRUE), class = "white-space: nowrap")
get_important_terms(eresList$KEGG_2019, output_dir, "ubi_c6_kegg")
```
...
### GO_Biological_Process_2018
```{r c7_go_9, fig.width=8}
eresList$GO_Biological_Process_2018 %>%
  plot_enrichr("GO_Biological_Process_2018")
datatable(eresList[[1]], options = list(scrollX = TRUE), class = "white-space: nowrap")
get_important_terms(eresList$GO_Biological_Process_2018, output_dir, "ubi_c4_go")
```

### KEGG_2019
```{r c7_kegg_9, fig.width=8}
eresList$KEGG_2019 %>%
  plot_enrichr("KEGG_2019") 
datatable(eresList[[2]], options = list(scrollX = TRUE), class = "white-space: nowrap")
get_important_terms(eresList$KEGG_2019, output_dir, "ubi_c4_kegg")
```
